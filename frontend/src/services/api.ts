...
export const placesAPI = { getAll: (params?: Record<string, unknown>) => api.get('/places', { params }) };
export const weatherAPI = { get: (city: string) => api.get('/weather', { params: { city } }) };
export const travelServicesAPI = { getAll: (params?: Record<string, unknown>) => api.get('/travel-services', { params }), reserve: (data: Record<string, unknown>) => api.post('/reservations', data) };
export const hospitalsAPI = { getAll: (params?: Record<string, unknown>) => api.get('/hospitals', { params }) };
