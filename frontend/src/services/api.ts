...
export const discoveriesAPI = {
  getAll: (params?: Record<string, unknown>) => api.get('/discoveries', { params }),
  getById: (id: string) => api.get(`/discoveries/${id}`),
  create: (data: FormData) => api.post('/discoveries', data),
  verify: (id: string, data: Record<string, unknown>) => api.patch(`/discoveries/${id}/verify`, data),
};
export const tripsAPI = {
  getAll: (params?: Record<string, unknown>) => api.get('/trips', { params }),
  getById: (id: string) => api.get(`/trips/${id}`),
  create: (data: Record<string, unknown>) => api.post('/trips', data),
  generate: (data: Record<string, unknown>) => api.post('/trips/generate', data),
